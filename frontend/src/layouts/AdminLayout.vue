      ...
      <div class="max-w-6xl mx-auto px-6 h-14 flex items-center justify-between">
        <div class="flex items-center gap-6">
          <div class="flex items-center gap-2">
            ...
            <span class="text-xs bg-purple-50 text-purple-700 px-2 py-0.5 rounded-full font-medium">Admin</span>
          </div>
          <div class="flex items-center gap-1">
            <RouterLink
              to="/admin/pending"
              class="text-sm px-3 py-1.5 rounded-lg text-gray-500 hover:text-gray-900 hover:bg-gray-100 transition-colors"
              active-class="text-purple-700 font-medium bg-purple-50 hover:bg-purple-50 hover:text-purple-700"
            >
        ...
        <div class="flex items-center gap-3">
          <div class="text-right">
            ...
            <p class="text-xs text-gray-400 leading-tight">Admin</p>
          </div>
          <button
